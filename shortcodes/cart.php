<?php
/**
 * Cart Coupon shortcode
 *
 *
 */
function get_jigoshop_coupon_cart($atts) {
    return jigoshop_shortcode_wrapper('jigoshop_coupon_cart', $atts);
}

function jigoshop_coupon_cart($atts) {
